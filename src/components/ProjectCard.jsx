...
export const ProjectCard = ({ image, name, description, link1, link2 }) => {
    ...
    return (
        <div>
            ...
            <p className="text-purple text-3xl mb-5"> {name}</p>
            <p className="text-gray text-l mb-4">{description}</p>
            ...
            <div className="flex justify-between">
                <a href={link2} target="_blank" className="text-purple text-xl underline">Github</a>
                <a href={link1} target="_blank" className="text-purple text-xl underline">Website</a>
            </div>
        </div>
    );
}
